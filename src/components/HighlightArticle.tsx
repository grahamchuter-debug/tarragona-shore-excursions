...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Tarragona Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {(page.slug === "cape-spartel" || page.slug === "tarragona-medina") && (
            <SignatureExperienceCallout
              context={page.slug === "cape-spartel" ? "portofino" : "savona"}
            />
          )}

          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Tarragona guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Tarragona — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
