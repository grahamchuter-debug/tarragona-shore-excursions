...
function MarkSvg({
  ...
  // Concept A (active): Anchor Arch — Ligurian harbour mark meeting a restrained anchor.
  return (
    <svg
      width={size}
      height={size}
 ...
 *
 * Logo refinement (Savona prototype): icon slightly subordinate to SAVONA,
...
export function DestinationLogo({
  ...
  const onDark = tone === "on-dark";
  // ~12% smaller than the first prototype so SAVONA stays dominant
