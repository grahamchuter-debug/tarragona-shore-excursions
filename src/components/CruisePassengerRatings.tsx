  ...
  return (
    <section className="section-padding bg-coastal-50 border-b border-coastal-100">
      <div className="container-wide max-w-4xl">
        <p className="section-eyebrow">Tarragona cruise port ratings</p>
        <h2 className="section-title mt-2">How Tarragona scores for cruise passengers</h2>
