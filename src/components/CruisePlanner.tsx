...
export function CruisePlanner() {
  ...
  const [interests, setInterests] = useState<string[]>(["roman", "independent"]);
  ...
  return (
    <div className="card-feature">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button type="button" onClick={generate} className="btn-primary">Build my Tarragona plan</button>
      ...
      {plan && (
        <div className="mt-8 space-y-8">
          ...
          <p className="text-xs text-gray-500">Guidance is indicative — always confirm your ship&apos;s all-aboard time and build a 60–90 minute return buffer. Heat on amphitheatre terraces and Part Alta climbs can slow your return — protect your buffer.</p>
        </div>
      )}
    </div>
  );
