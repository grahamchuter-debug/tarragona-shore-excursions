...
export const metadata = buildMetadata({
  title: "Tarragona Cruise Ship Schedules",
  description:
    "Tarragona cruise ship schedules by year and month. See which ships call before booking Old Town, Mediterranean Balcony or city excursions.",
  path,
  keywords: ["Tarragona cruise ship schedule", "Tarragona cruise calendar", "Tarragona ship schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Tarragona Cruise Ship Schedules", description: "Tarragona cruise ship schedules by year and month.", path })]} />
      <PageHero title="Tarragona Cruise Ship Schedules" subtitle="See which ships are in port before you book Catalonia excursions. Times and berths are indicative — always confirm with your cruise line." compact />
