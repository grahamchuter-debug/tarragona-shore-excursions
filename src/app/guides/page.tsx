...
const path = "/guides";
const description =
  "Catalonia cruise planning guides from Tarragona — Old Town, Part Alta, Mediterranean Balcony, Cathedral quarter and practical port-day advice.";

export const metadata = buildMetadata({
  title: "Catalonia Cruise Planning Guides from Tarragona",
  description,
  path,
  keywords: [
    "Tarragona cruise port guide",
    "Tarragona Old Town from cruise port",
    "Tarragona shore excursions guide",
    "Mediterranean Balcony from Tarragona",
    "Catalonia cruise guide",
  ],
});
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({ title: "Catalonia Cruise Planning Guides from Tarragona", description, path }),
        ]}
      />
      <PageHero
        title="Catalonia Cruise Planning Guides"
        subtitle="Your gateway to Tarragona — Old Town, Part Alta, Mediterranean Balcony, Cathedral quarter and practical advice for every type of cruise passenger."
      ...
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="section-subtitle">Practical guides to Moroccan highlights with transfer times and return-to-ship advice.</p>
