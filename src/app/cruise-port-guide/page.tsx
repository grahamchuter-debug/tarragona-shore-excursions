...
const description =
  "The complete Tarragona cruise port guide — terminal access, walking routes to UNESCO Roman Tarraco, taxis, Old Town and return-to-ship timing.";
...
export const metadata = buildMetadata({
  ...
  keywords: [
    ...
    "Tarragona port to amphitheatre",
...
const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Tarragona Cruise Port Guide", path },
];
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          <div className="mt-12">
            <FAQSection faqs={portGuideFaqs} title="Tarragona port FAQs" />
          </div>
