...
export const metadata = buildMetadata({
  ...
  path,
  image: image.src,
  imageAlt: "Tarragona coastline — future Signature Experience from Tarragona cruise port",
  keywords: [
    "Signature Mediterranean of Gibraltar Discovery",
    "Tarragona shore excursions",
    "small group Tarragona tour",
...
const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Signature Mediterranean of Gibraltar Discovery", path },
];

export default function SignatureTarragonaExperiencePage() {
  return (
    <>
      <JsonLd
        data={[
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="placeholder-widget mt-8">
            ...
            <p className="mt-3 text-gray-700 leading-relaxed">
              ...
              guests, cruise-timed routing and a carefully paced Tarragona day. It is a
          ...
          <div className="mt-12">
            <FAQSection faqs={signatureRivieraExperience.faqs} title="Future Premium Roman Discovery — FAQs" />
          </div>
