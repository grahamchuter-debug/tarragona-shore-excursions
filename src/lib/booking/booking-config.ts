...
export const bookingPrototypeTour: BookingTourView = (() => {
  const first = getBookableProduct("portofino-santa-margherita");
...
export const bookingPricingConfig = {
  ...
  priceConfigured: Boolean(getBookableProduct("portofino-santa-margherita")),
  ...
  returnGuaranteeDetail:
    "Your itinerary is planned to return you to Tarragona with time before your ship departs.",
