# Tarragona Shore Excursions — remaining destination work

Config generated for `tarragona` with domain `tarragonashoreexcursions.com` and `contactMode: "central"` (info@wowatour.com).
...
- [ ] `wrangler d1 create tarragona-bookings` → set database_id
- [ ] Stripe + Resend secrets
- [ ] Confirm DNS for tarragonashoreexcursions.com
